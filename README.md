...
│   ├── Controllers/                 # One file per resource (6 active controllers)
│   ├── Data/
...
│   │   └── Enums/                   # 10 enum files (UserRole, CourseStatus, etc.)
│   ├── Repositories/
│   │   ├── Interfaces/              # 14 IXxxRepository interfaces
│   │   └── Implementations/         # 14 XxxRepository classes
...
├── add-migrations.bat               # Shortcut: dotnet ef migrations add <Name>
...
| Pattern | Repository Pattern | 14 interface + implementation pairs |
...
# Or: dotnet ef migrations add <Name> --project EduLearn.API --startup-project EduLearn.API
...
**Exception:** `EnrollmentsController` also injects `AppDbContext` for `Database.BeginTransactionAsync()` — transactions require the DbContext. All data reads/writes still go through repositories.
