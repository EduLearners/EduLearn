...
public class EnrollmentsController : ControllerBase
{
    ...
    {
        // Validate student exists — outside transaction (read-only)
        ...
        try
        {
            // Load section with Course navigation for response
            ...
            // Update section enrolled count if directly enrolled
